...
<script>
  ...
  $('.fav').click(function(){
    // alert(111);
      ...
      $.ajax({
          type:'post',
          url: "https://api.winnel.top/createcollect",
          dataType:'json',
...
        })
    ...
    //属性id
      ...
      // alert(shop_price);    
          var user_id = $('input[name="user_id"]').val();
          // alert(user_id);
          $.post('https://api.winnel.top/addcart',{user_id:user_id,goods_id:goods_id,buy_number:buy_number,goods_attr_id:goods_attr_id},function(res){
			//未登录
      // console.log(res);
            if(res.code=='1001'){
