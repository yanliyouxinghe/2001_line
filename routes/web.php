...
Route::post('/delhistorys','Index\ListController@delhistorys');    //登录后清空 历史浏览记录
...
Route::any('/uploadass','Admin\GoodsController@uploadass');//图片上传接口
...
Route::get('/getattr','Admin\GoodsController@getattr')->name('goods.getattr');//商品属性
