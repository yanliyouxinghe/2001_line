...
class CartController extends Controller
{
    ...
    public function cart_del(){
        ...
        $url = "https://api.winnel.top/cart_del";
    ...
    public function buy_jian(){
        ...
        $url = "https://api.winnel.top/buy_jian";
    ...
    public function buy_jia(){
        ...
        $url = "https://api.winnel.top/buy_jia";
    ...
    public function cart_zprice(){
        ...
        $url = "https://api.winnel.top/cart_zprice";
