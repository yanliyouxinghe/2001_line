...
class GoodsController extends Controller
{
    function goodsinfo($id){
        $url = 'https://api.winnel.top/goods/'.$id;
        $data = geturl($url);
        // print_r($data);exit;
        ...
        if(!$user_id){
            ...
            //登录后 添加历史浏览记录
            $url = 'https://api.winnel.top/createhistory/'.$id;
            // geturl($url);
            posturl($url,$data);
        }
        ...
        return view('/goods/goodsinfo',['goodsinfo'=>$goodsinfo,'attr'=>$attr,'recommended'=>$recommended,'coupons'=>$coupons,'user_id'=>$user_id]);
    }
   ...
   public function listcollect(){
        ...
        $data['user_id']=$user_id;
        $url = 'https://api.winnel.top/listcollect';
   ...
   public function cancel(){
        ...
        $url = 'https://api.winnel.top/cancel';
 ...
 //领取优惠券
    function coupons($id){
        ...
        $data['goods_id'] = $id;
        //  print_r($data);die;
        $url = "https://api.winnel.top/coupons";
        // print_r($url);die;
        $data=posturl($url,$data);
        // print_r($data);die;
        return view('goods.coupons',['data'=>$data,'user_id'=>$user_id]);
    }
