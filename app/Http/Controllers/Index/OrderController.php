...
class OrderController extends Controller
{
    ...
    public function index(){
        ...
        //展示收货人信息
        $url = 'https://api.winnel.top/addressinfo';
        ...
        $url = "https://api.winnel.top/account";
        $account = posturl($url,$data);
        // print_r($account);die;
        $coupons = $account['data']['coupons'];
        // print_r($coupons);die;
        //使用优惠券
        // $url = 'https://api.winnel.top/couponsuse/'.$goods_id;
        // $coupons=geturl($url);
        // echo 11111;
    ...
    public function address_del(){
        ...
        $user_id=Redis::hget('reg','user_id');
        $data['user_id']=$user_id;
        $url = 'https://api.winnel.top/address_del';
